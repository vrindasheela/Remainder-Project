...
win.resizable(0, 0)
aLabel=ttk.Label(win,  text="REMINDER APPLICATION")
...
#textbox
    ...
    aLabel=ttk.Label(win2,  text="Reminder on:")
...
#function
    ...
    #name1=name.get()
        ...
        messagebox.showinfo("Confirmation", "Reminder Updated"  )
    #name.bind('<Return>', ef)
#button
...
#button
    ...
    win3.mainloop()
#Button1
action=ttk.Button(win,  text="Create Reminder",  command=af)
action.grid(column=15,  row=15)
#Button2
action=ttk.Button(win,  text="Update Reminder",  command=df)
action.grid(column=15,  row=16)
#Button3
action=ttk.Button(win,  text="View Reminder",  command=vf)
